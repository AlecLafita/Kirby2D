...
void BaseObject::init(ShaderProgram &shaderProgram, Scene* scene) {
	...
	sprite = Sprite::createSprite(glm::ivec2(OBJECT_SIZE_X, OBJECT_SIZE_Y), glm::vec2(sizeInSpriteSheetX, sizeInSpriteSheetY), &spritesheet, &shaderProgram); //SPRITE SIZE OF ALL OBJECTS 16x16
